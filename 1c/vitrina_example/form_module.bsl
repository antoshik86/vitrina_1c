...
Процедура СоздатьЭлементыФормы()
	...
	Попытка
		...
		Сообщить("  4.5. Кнопка создана");

		// Чекбокс отладки
		СздПоле(ЭтотОбъект, "ПолеОтладка", Родитель, "Режим отладки", 2, "РежимОтладки");
		Сообщить("  4.6. Чекбокс отладки создан");
